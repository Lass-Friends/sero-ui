...
const meta: Meta<typeof Badge> = {
  ...
  argTypes: {
    variant: {
      control: "select",
      options: ["default", "status", "attending", "satellite", "number"],
    },
    size: {
      control: "select",
      options: ["sm", "default"],
...
export const Group: Story = {
  render: () => (
    <div className="flex items-center -space-x-1">
      <Badge variant="default" className="bg-[#FAFAFA]">Conference</Badge>
      <Badge variant="default" className="bg-[#FB923C]">AI</Badge>
      <Badge variant="default" className="bg-[#FBBF24]">DeFi</Badge>
      <Badge variant="default" className="bg-[#C084FC]">Developer</Badge>
      <Badge variant="default" className="bg-[#22D3EE]">Infrastructure</Badge>
    </div>
  ),
};
...
export const Attending: Story = {
  render: () => (
    ...
    >
      <span className="text-xs font-semibold tracking-[-0.03em]">32</span>
      <span className="-ml-0.5 text-xxs font-medium tracking-[-0.03em] text-muted-foreground">(8)</span>
    </Badge>
  ),
};
...
export const Satellite: Story = {
  render: () => (
    <Badge variant="satellite" icon={<SignalIcon className="size-4 text-[#A3E635]" />}>
      Badge
    </Badge>
  ),
};
